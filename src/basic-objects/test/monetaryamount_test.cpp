...
TEST(MonetaryAmountTest, SizeAsStrWithoutSpaces) {
  EXPECT_EQ(MonetaryAmount("804.62EUR").strLen(MonetaryAmount::WithSpaces::kNo), 9);
  EXPECT_EQ(MonetaryAmount("-210.50 CAKE").strLen(MonetaryAmount::WithSpaces::kNo), 10);
  EXPECT_EQ(MonetaryAmount("05AUD").strLen(MonetaryAmount::WithSpaces::kNo), 4);
  EXPECT_EQ(MonetaryAmount("746REPV2").strLen(MonetaryAmount::WithSpaces::kNo), 8);
  EXPECT_EQ(MonetaryAmount("0").strLen(MonetaryAmount::WithSpaces::kNo), 1);
  EXPECT_EQ(MonetaryAmount("35").strLen(MonetaryAmount::WithSpaces::kNo), 2);
  EXPECT_EQ(MonetaryAmount("-42").strLen(MonetaryAmount::WithSpaces::kNo), 3);
  EXPECT_EQ(MonetaryAmount("-42.7009").strLen(MonetaryAmount::WithSpaces::kNo), 8);
}
...
TEST(MonetaryAmountTest, Truncate) {
  ...
  EXPECT_EQ(ma, MonetaryAmount((std::numeric_limits<MonetaryAmount::AmountType>::max() / ipow10(14)) + 1L,
                               CurrencyCode(), 4));
  ...
  EXPECT_EQ(ma, MonetaryAmount((std::numeric_limits<MonetaryAmount::AmountType>::min() / ipow10(14)) - 1L,
                               CurrencyCode(), 4));
}
