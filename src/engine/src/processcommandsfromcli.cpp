...
void ProcessCommandsFromCLI(std::string_view programName, const CoincenterCommands &coincenterCommands,
  ...
  GeneralConfig generalConfig(LoggingInfo(generalConfigData["log"]), fiatConversionQueryRate,
  ...
  Coincenter coincenter(coincenterInfo, coincenterCommands.exchangesSecretsInfo);
