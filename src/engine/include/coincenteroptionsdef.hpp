...
struct CoincenterAllowedOptions : private CoincenterCmdLineOptionsDefinitions {
  ...
  static constexpr CommandLineOptionWithValue value[] = {
      ...
      {{{"Private queries", 3902}, "--max-age", "<time>", "Only select withdraws with given maximum age."},
       &OptValueType::maxAge},
      {{{"Trade", 4000}, "buy", "<amt cur[,exch1,...]>", kSmartBuy}, &OptValueType::buy},
      {{{"Trade", 4000}, "sell", "<amt[%]cur[,exch1,...]>", kSmartSell}, &OptValueType::sell},
      {{{"Trade", 4000},
        "sell-all",
        "<cur[,exch1,...]>",
      ...
      {{{"Trade", 4030}, "--update-price", "<time>", kTradeUpdatePrice}, &OptValueType::tradeUpdatePrice},
      {{{"Trade", 4030}, "--sim", "", kSimulationMode}, &OptValueType::tradeSim},
