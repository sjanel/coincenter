...
TEST_F(WalletTest, NoDestinationTag) {
  Wallet wallet(ExchangeName(ExchangeNameEnum::kraken, "user1"), "ETH", "MyAddress", "", walletCheck,
...
TEST_F(WalletTest, DestinationTag1) {
  Wallet wallet(ExchangeName(ExchangeNameEnum::kraken, "user1"), "ETH", "023432423423xxxx54645654", "346723423",
...
TEST_F(WalletTest, DestinationTag2) {
  ...
  Wallet wallet(ExchangeName(ExchangeNameEnum::kraken, "user1"), "XRP", std::move(address), "superTAG4576", walletCheck,
                AccountOwner("SmithJohn", "스미스존"));
