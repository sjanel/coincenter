...
///    'YYYY-MM-DD HH:MM:SS'
string ToString(TimePoint timePoint, const char* format = kTimeYearToSecondTSeparatedFormatUTC);

/// Parse a string representation of a given time point and return a time_point.
TimePoint FromString(std::string_view timeStr, const char* format = kTimeYearToSecondTSeparatedFormatUTC);
