...
```bash
data/serialized/<market-order-book|trades>/
├── binance
│   ├── BTC-EUR
│   │   └── 2024
│   │       └── 01
...
With this command left alive several days, you should obtain a list of files like in the above example.
