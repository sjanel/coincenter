...
| *query*     | **acceptEncoding**                 | Comma separated list of accepted encodings (ex: `"br,gzip,deflate"`), or empty | Sets the list of accepted encodings passed as the `Accept-Encoding` request header. When empty, the aeronet HTTP client automatically advertises the compression codecs it was compiled with (gzip/deflate, zstd, brotli) and transparently decompresses the responses.                                                                                                                                                                                                                                      |
